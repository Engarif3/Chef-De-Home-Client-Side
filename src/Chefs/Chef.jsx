...
const Chef = ({chef}) => {
  ...
  return (
    <div>
      ...
      style={{ width: "14rem", height: "24rem", position: "relative", backgroundColor:"black" }}
    >
      <img className="img-fluid w-100 h-50 mx-auto p-1 rounded-4-top" src={image} alt=""  style={{borderRadius: "15px 15px 0 0"}}/>
        ...
        >
          ...
          <Button className='w-75 mb-2' variant="primary">View Recipes</Button>
            </div>
          </div>
